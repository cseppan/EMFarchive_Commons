...
public class SpatialSurrogatesExporter extends GenericExporter {
    public SpatialSurrogatesExporter(Dataset dataset, Datasource datasource, SqlDataTypes types) {
        super(dataset, datasource, new SpatialSurrogatesFileFormat(types));
    }
    
    public SpatialSurrogatesExporter(Dataset dataset, Datasource datasource, SqlDataTypes types,
            DataFormatFactory factory) {
        super(dataset, datasource, new SpatialSurrogatesFileFormat(types), factory);
    }
