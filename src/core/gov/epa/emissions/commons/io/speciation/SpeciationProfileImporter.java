...
public class SpeciationProfileImporter implements Importer {
    ...
    public SpeciationProfileImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
    ...
    public SpeciationProfileImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
        ...
        FileFormat fileFormat = new SpeciationProfileFileFormat(sqlDataTypes);
    ...
    private void doImport(File file, Dataset dataset, String table, TableFormat tableFormat) throws Exception {
        ...
        try {
            ...
            reader = new DelimiterIdentifyingFileReader(file, formatUnit.fileFormat().cols().length);
    ...
    private void loadDataset(File file, String table, TableFormat format, Dataset dataset, List comments) {
