...
public class SpeciationComboProfileFileFormat implements FileFormatWithOptionalCols, DelimitedFileFormat {
    ...
    public Column[] optionalCols() {
        ...
        columns.add(new Column("PROF2", types.stringType(5), 5, new StringFormatter(5)));
        columns.add(new Column("FRAC2", types.realType(), new RealFormatter()));
        columns.add(new Column("PROF3", types.stringType(5), 5, new StringFormatter(5)));
        columns.add(new Column("FRAC3", types.realType(), new RealFormatter()));
        columns.add(new Column("PROF4", types.stringType(5), 5, new StringFormatter(5)));
        columns.add(new Column("FRAC4", types.realType(), new RealFormatter()));
        columns.add(new Column("PROF5", types.stringType(5), 5, new StringFormatter(5)));
        columns.add(new Column("FRAC5", types.realType(), new RealFormatter()));
        columns.add(new Column("PROF6", types.stringType(5), 5, new StringFormatter(5)));
        columns.add(new Column("FRAC6", types.realType(), new RealFormatter()));
        columns.add(new Column("PROF7", types.stringType(5), 5, new StringFormatter(5)));
        columns.add(new Column("FRAC7", types.realType(), new RealFormatter()));
        columns.add(new Column("PROF8", types.stringType(5), 5, new StringFormatter(5)));
        columns.add(new Column("FRAC8", types.realType(), new RealFormatter()));
        columns.add(new Column("PROF9", types.stringType(5), 5, new StringFormatter(5)));
        columns.add(new Column("FRAC9", types.realType(), new RealFormatter()));
        columns.add(new Column("PROF10", types.stringType(5), 5, new StringFormatter(5)));
    ...
    public Column[] minCols() {
        ...
        columns.add(new Column("PROF1", types.stringType(5), 5, new StringFormatter(5)));
