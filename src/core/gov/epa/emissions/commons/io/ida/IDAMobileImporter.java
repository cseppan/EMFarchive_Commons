...
public class IDAMobileImporter implements Importer {
    ...
    public IDAMobileImporter(File folder, String[] fileNames, Dataset dataset, DbServer dbServer,
            SqlDataTypes sqlDataTypes, DataFormatFactory factory) throws ImporterException {
        delegate = new IDAImporter(dataset, dbServer, sqlDataTypes);
        delegate.setup(folder, fileNames, new IDAMobileFileFormat(sqlDataTypes), factory);
    }
