...
public class ORLNonPointExporter implements Exporter {
    ...
    public ORLNonPointExporter(Dataset dataset, String rowFilters, DbServer dbServer, Integer optimizedBatchSize) {
        delegate = new ORLExporter(dataset, rowFilters, dbServer, fileFormat(dbServer.getSqlDataTypes()), optimizedBatchSize);
    }

    public ORLNonPointExporter(Dataset dataset, String rowFilters, DbServer dbServer, 
