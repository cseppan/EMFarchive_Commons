...
public class ORLPlantClosureImporter implements Importer {

    private ORLImporter delegate;

    public ORLPlantClosureImporter(File folder, String[] filePatterns, Dataset dataset, DbServer dbServer,
            SqlDataTypes sqlDataTypes) throws ImporterException {
        FileFormatWithOptionalCols fileFormat = new ORLPlantClosureFileFormat(sqlDataTypes);
    ...
    public ORLPlantClosureImporter(File folder, String[] filePatterns, Dataset dataset, DbServer dbServer,
        ...
        FileFormatWithOptionalCols fileFormat = new ORLPlantClosureFileFormat(sqlDataTypes, factory.defaultValuesFiller());
