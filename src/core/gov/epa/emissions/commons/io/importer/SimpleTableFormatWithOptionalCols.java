...
/**
 * supports unversioned datasets
 */
public class SimpleTableFormatWithOptionalCols implements TableFormatWithOptionalCols {

    private FileFormatWithOptionalCols base;

    private Column[] cols;

    public SimpleTableFormatWithOptionalCols(FileFormatWithOptionalCols base, SqlDataTypes types) {
        this.base = base;
