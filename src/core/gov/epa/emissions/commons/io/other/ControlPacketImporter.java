...
public class ControlPacketImporter implements Importer {
    ...
    public ControlPacketImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
            SqlDataTypes sqlDataTypes) throws ImporterException {
        FileFormatWithOptionalCols fileFormat = new ControlPacketFileFormat(sqlDataTypes);
    ...
    public ControlPacketImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
        ...
        FileFormatWithOptionalCols fileFormat = new ControlPacketFileFormat(sqlDataTypes, factory
                .defaultValuesFiller());
