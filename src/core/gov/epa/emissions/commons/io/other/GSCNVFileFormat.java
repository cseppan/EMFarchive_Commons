...
public class GSCNVFileFormat implements FileFormatWithOptionalCols, DelimitedFileFormat {
    ...
    private Column[] createMinCols() {
        ...
        cols.add(new Column("Pollutant_1", types.stringType(16), new StringFormatter(16)));
        cols.add(new Column("Pollutant_2", types.stringType(16), new StringFormatter(16)));
        cols.add(new Column("Speciation_Code", types.stringType(5), new StringFormatter(5)));
