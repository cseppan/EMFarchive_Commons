...
public class AllowablePacketImporter implements Importer {
    ...
    public AllowablePacketImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
            SqlDataTypes sqlDataTypes) throws ImporterException {
        FileFormatWithOptionalCols fileFormat = new AllowablePacketFileFormat(sqlDataTypes);
    ...
    public AllowablePacketImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
        ...
        FileFormatWithOptionalCols fileFormat = new AllowablePacketFileFormat(sqlDataTypes, factory
                .defaultValuesFiller());
    ...
    private void doImport(File file, Dataset dataset, String table, FileFormatWithOptionalCols fileFormat,
        ...
        try {
            ...
            reader = new DelimiterIdentifyingFileReader(file, new String[] { "#", "/ALLOWABLE", "/END/" },
