...
public class NIFPointImporter implements Importer {
    ...
    public NIFPointImporter(File folder, String[] files, Dataset dataset, DbServer dbServer, SqlDataTypes sqlDataTypes)
            throws ImporterException {
        this(folder, files, dataset, dbServer, sqlDataTypes, new NonVersionedDataFormatFactory());
    }

    public NIFPointImporter(File folder, String[] filePatterns, Dataset dataset, DbServer dbServer, SqlDataTypes sqlDataTypes,
