...
public class CEMHourSpecInventFileFormat implements FileFormat {
    ...
    private Column[] createCols(SqlDataTypes types) {
        ...
        columns.add(new Column("ORISID", types.stringType(10), new StringFormatter(10)));
        columns.add(new Column("BLRID", types.stringType(10), new StringFormatter(10)));
