...
public class TableFormatWithOptionalCols implements FileFormatWithOptionalCols,
	...
	public TableFormatWithOptionalCols(FileFormatWithOptionalCols base,
			SqlDataTypes types) {
		this.base = base;
	...
	private Column[] createCols(SqlDataTypes types) {
		...
		Column inlineComments = new Column("Comments", types.stringType(128),
				new StringFormatter(128));
